...
// CreditNoteData datos principales de la nota crédito
type CreditNoteData struct {
	Number             string
	CUDE               string
	IssueDate          time.Time
	IssueTime          string
	CreditNoteTypeCode string // "91" = Nota crédito que referencia factura electrónica
	Note               string
...
// BillingReferenceData referencia a la factura que se corrige
...
// CreditNoteLineData línea de nota crédito
type CreditNoteLineData struct {
	ID                  string
	Description         string
	ProductCode         string
	Quantity            float64
...
// TotalsData totales de la nota crédito
...
// CreditNoteTemplateData datos para template
type CreditNoteTemplateData struct {
	...
	// Lines
	CreditNoteLines []CreditNoteLineTemplateData
...
// CreditNoteLineTemplateData línea de nota crédito
type CreditNoteLineTemplateData struct {
	ID                    string
	UnitCode              string
	Quantity              string
	LineExtensionAmount   string
