...
// Builder constructor de notas crédito
type Builder struct {
...
// SetCreditNoteData establece datos básicos
func (b *Builder) SetCreditNoteData(number, cude, issueDate, issueTime string) *Builder {
	b.data.CreditNoteNumber = number
	b.data.CUDE = cude
...
func (b *Builder) AddLine(line CreditNoteLineTemplateData) *Builder {
	b.data.CreditNoteLines = append(b.data.CreditNoteLines, line)
	b.data.LineCount = len(b.data.CreditNoteLines)
	return b
}
...
func (b *Builder) Build() ([]byte, error) {
	...
	if err := tmpl.ExecuteTemplate(&buf, "creditnote.tmpl", b.data); err != nil {
